...
\begin{align*}
	\frac{\cos z}{z^2}
	={}& \frac{1}{z^2} \sum_{k \geq 0} \text{\enquote{$k$ är udda}} \cdot \frac{(-1)^\frac{k}{2}}{k!} z^k\\
	%
	={}& \frac{1}{z^2} \sum_{k \geq 0} \text{\enquote{$k$ är udda}} \cdot \frac{(-1)^\frac{k}{2}}{k!} z^{k - 2}.
\end{align*}
...
\begin{align*}
	\cos x = \sum_{k \geq 0} \text{\enquote{$k$ är udda}} \frac{(-1)^\frac{k}{2}}{k!} x^k.
\end{align*}
